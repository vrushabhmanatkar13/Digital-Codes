...
public class Registration_Page extends Baseclass {
	...
	public void registerUser(String firstName, String lastName, String securityQuestion, String securityAns,
			String emailId, String Password, String conformPassword, String spam) {
