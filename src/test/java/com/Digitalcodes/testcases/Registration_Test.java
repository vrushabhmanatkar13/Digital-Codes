...
public class Registration_Test extends Prerequisites_Teardown{
	...
	@Test(priority = 1, description  = "Verfiy user able to Register with valid Data",groups = {"Smoke","Regression"})
	public void TC_Registeruser_ValidData() throws InterruptedException {
		...
		register.registerUser(userdata.get("NewFIRST_NAME"), userdata.get("NewLAST_NAME"), jsonArrayValue("valid-data", "security"), userdata.get("NewFIRST_NAME"), EMAIL, userdata.get("NewPASSWORD"), userdata.get("NewPASSWORD"), jsonArrayValue("valid-data", "spam"));
	...
	public void TC_Registeruser_InValidData(String category,String firstname, String lastname, String securityque, String securityans, String email, String password ) {
		...
		register.registerUser(firstname, lastname, securityque, securityans, email, password, password, jsonArrayValue("valid-data", "spam"));
